"""Apply the account route-management policy only to the marked disposable database."""
import pathlib
import subprocess
...
if __name__ == '__main__':
    ...
    migration = ROOT / 'supabase/migrations/20260928000000_account_route_management.sql'
