-- Edge Function helper: Consolidate 3 queries into 1 for get_next_item workflow
-- Performance optimization: ~400-600ms savings (3 HTTP requests → 1)
-- Created: 2026-01-11 (Session 33, Priority 3)
...
COMMENT ON FUNCTION get_next_item_data IS 'Consolidates Get Session + Get Machines + Get Items queries for get_next_item workflow performance optimization';
