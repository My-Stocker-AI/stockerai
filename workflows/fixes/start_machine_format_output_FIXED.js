// =============================================================================
// start_machine workflow → Format Output node (CONTRACT COMPLIANT)
// FIX: Wraps first item in item1 object to match frontend contract
// =============================================================================
...
function generateDisplayText(itemData, parsed, parsed2) {
  ...
  if (itemData.count === 2 && parsed2) {
    ...
    var item2 = parsed2.name + (parsed2.size ? ' (' + parsed2.size + ')' : '') + ' X ' + itemData.quantity;
...
// ✅ FIX: Wrap first item in item1 object (matches contract)
output.item1 = {
