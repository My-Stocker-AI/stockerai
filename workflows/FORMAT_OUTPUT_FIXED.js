// =============================================================================
// FIX: Format Output - Add missing next_machine field
// BUG: next_machine field not passed through, causing frontend to see undefined
// DATE: 2026-01-26
// =============================================================================
...
if (data.action === 'next_machine') {
  ...
  output.next_machine = data.next_machine;  // ← FIX: Added this line
