// ============================================================================
// PHASE 2: Determine Next State (WITHOUT increment - that's next node)
// ============================================================================
//
// This node determines the action, the HTTP Request node does the increment
//
...
if (nextItem) {
  ...
  return [{
    json: {
      ...
      // PHASE 2: Progress tracking - for next node to increment
      items_remaining: newItemsRemaining,
      completed_items: completedItems,  // Current (before increment)
      items_to_increment: itemsToIncrement,  // How many to add
      new_completed_items: newCompletedItems,  // What it will be after
      total_items: totalItems,
      machine_id: currentMachineId,  // For HTTP Request node
