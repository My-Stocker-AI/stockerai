// ============================================================================
// PHASE 2: Determine Next State + Increment Completed Items (COMBINED)
// ============================================================================
//
// WHAT THIS DOES:
// 1. Reads machines.completed_items from database
// 2. Determines next action (next_item, next_machine, or complete)
// 3. If action='next_item', increments completed_items in database
// 4. Returns result for Format Output
//
// REPLACES: "Determine Next State" node (single node, not two)
//
// CONTRACT COMPLIANCE:
...
if (nextItem) {
  ...
  // Calculate how many items to increment
  ...
  return [{
    json: {
      ...
      // INVENTORY FIX: Include inventory fields
      ...
      // PHASE 2: Progress tracking with completed_items
      items_remaining: newItemsRemaining,
      completed_items: newCompletedItems,  // Updated value after increment
      total_items: totalItems,
